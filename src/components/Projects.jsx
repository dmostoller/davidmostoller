...
export default function Projects() {
  ...
  return (
    ...
    <div className="ui fluid container" >
        ...
        <div className='ui center aligned three column grid' style={{ marginBottom: "25px"}}>
            <div className='ui stackable inverted link cards' style={{marginTop: "25px"}}>
            <div className='column'>
              <Link to='philareact' target="_blank" className="ui card" style={{ margin: "25px", height: "200px", width: "350px" }}>
              ...
              <Link to='https://invoice-creator-cmsb.onrender.com/' target="_blank" className="ui card" style={{ margin: "25px", height: "200px", width: "350px" }}>
                <div className="content">
                  <div className='header' style={{ marginBottom: "0px" }}>
                    <img className="ui mini image" src={invoice} alt="Invoice Creator"></img>
                    <h1>Invoice Creator</h1>
                  </div>
                  <div className="meta"><h3>A user-friendly tool for creating invoices.</h3></div>
                </div>
              </Link>
            </div>
            <div className='column'>
               <Link to='https://typenetwork.com/' className="ui card" style={{ margin: "25px", height: "200px", width: "350px" }}>
                <div className="content">
                  <div className="header" style={{ marginBottom: "0px" }}>
                    <img className="ui tiny image" src={typenetwork} alt="TypeNetwork" style={{ width: "60px", marginTop: "8px" }}></img>
            ...
            <div className='column'>
              <Link to='https://www.southriverstudios.com/' target="_blank" className="ui card" style={{ margin: "25px", height: "200px", width: "350px" }}>
                <div className="content">
                  <div className='icon header' style={{ marginBottom: "0px" }}>
                    <Image
                      src={SRS}
                      ...
                      style={{ backgroundColor: 'darkblue', padding: '0px', width: '60px', height: '60px', borderRadius: '0%' }}
                    />
                    <h1 style={{ marginTop: "0px" }}>South River Studios</h1>
                  </div>
                  <div className="meta"><h3>Marketing and SEO Website</h3></div>
                </div>
              </Link>
